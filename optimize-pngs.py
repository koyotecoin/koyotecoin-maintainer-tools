...
./optimize-pngs.py ../koyotecoin_core/src/qt/res/movies/ ../koyotecoin_core/src/qt/res/icons/ ../koyotecoin_core/share/pixmaps/
    ...
    for file in os.listdir(absFolder):
        ...
        if extension.lower() == '.png':
            ...
            if contentHashPre != contentHashPost:
                print(
                    "Image contents of PNG file {} before and after crushing don't match".format(file))
                sys.exit(1)
...
for fileDict in outputArray:
    ...
    print(fileDict['file']+"\n  size diff from: "+str(fileDict['osize'])+" to: " +
          str(fileDict['psize'])+"\n  old sha256: "+oldHash+"\n  new sha256: "+newHash+"\n")

print("completed. Checksum stable: "+str(noHashChange) +
      ". Total reduction: "+str(totalSaveBytes)+" bytes")
